        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-zinc-400">
              Sign in to access your prompt inspector workspace, compare LLM models, and save history.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-mono">
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <span>Sign In to TokenGecko</span>
          ...
          <div className="text-center text-xs text-zinc-400 font-sans pt-2">
            ...
            <Link href="/signup" className="text-accent-orange hover:underline font-mono font-bold ml-1">
              Create an account
            </Link>
          </div>
        </div>
