    ...
    <div className="min-h-screen bg-[#0B0F17] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#0F172A]/80 border border-slate-800 backdrop-blur-md rounded-2xl p-8 shadow-2xl shadow-emerald-500/5">
        ...
        <p className="text-slate-400 text-sm text-center mb-6">
          Start analyzing prompts and comparing LLM models.
        </p>
        ...
        {successMsg && (
          <div className="mb-4 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-mono">
            {successMsg}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-mono text-slate-400 mb-1">Display Name (Optional)</label>
            <input
              type="text"
              value={name}
